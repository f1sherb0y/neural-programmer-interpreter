...
from modern_npi.graph.constants import (
    DEFAULT_ACTION,
    Opcode,
    Program,
    Symbol,
)
from modern_npi.graph.environment import GraphEnvironment, GraphObservation, NULL
...
class Decision:
    ...
    next_program: Program = Program.ACT
    next_arguments: Arguments = DEFAULT_ACTION
    has_child: bool = True
...
class DijkstraTrace:
    ...
    def _episode(
        self,
        program: Program,
        arguments: Arguments = DEFAULT_ACTION,
    ) -> Episode:
